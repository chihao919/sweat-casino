      ...
      <div className="relative w-full max-w-md">
        ...
        {authError && (
          <div className="mb-6 rounded-xl border border-red-500/40 bg-red-500/10 p-5">
            <p className="text-sm text-red-700 dark:text-red-400 dark:text-red-300 text-center whitespace-pre-line">{authError}</p>
            <button
              onClick={() => {
              ...
              className="mt-3 w-full rounded-lg bg-red-500/20 py-2 text-xs text-red-600 dark:text-red-400 dark:text-red-300 hover:bg-red-500/30 transition-colors"
            >
        ...
        {inAppBrowser && (
          <div className="mb-6 rounded-xl border border-amber-500/40 bg-amber-500/10 p-5 text-center">
            <p className="text-lg font-bold text-amber-700 dark:text-amber-300 dark:text-amber-300">
              ⚠️ 請使用外部瀏覽器開啟
            </p>
        ...
        <Card className="border-border bg-card shadow-xl shadow-foreground/10">
          <CardHeader className="pb-4 text-center">
            <CardTitle className="text-2xl text-foreground">開始遊戲</CardTitle>
          ...
          <CardContent className="pb-8 space-y-3">
            ...
            <Button
              ...
              className="w-full bg-foreground text-background font-semibold hover:bg-foreground/90 focus-visible:ring-red-600 disabled:opacity-50 h-14 text-lg"
            >
            ...
            <Button
              ...
              disabled={isLoading || inAppBrowser}
              className="w-full bg-card text-foreground font-semibold hover:bg-accent focus-visible:ring-red-600 disabled:opacity-50 h-14 text-lg border border-border"
            >
