...
function FAQItem({ icon, question, answer }: FAQItemProps) {
  ...
  return (
    <div className="border-b border-border last:border-0">
      ...
      {open && (
        <div className="pb-4 pl-9 text-muted-foreground leading-relaxed text-sm">
          {answer}
        </div>
      )}
    </div>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="relative mx-auto max-w-2xl px-4 py-12">
        ...
        <Separator className="mb-12 bg-muted" />
        ...
        <section className="mb-12">
          ...
          <Card className="border-border bg-card">
            ...
            <CardContent className="text-muted-foreground text-sm space-y-4">
              ...
              <div className="rounded-lg border border-zinc-700 bg-muted/50 p-4">
                <p className="text-foreground font-medium mb-1">Send your bug report to:</p>
                <a
                ...
                <p className="mt-1 text-muted-foreground text-xs">
                  Subject: <span className="text-muted-foreground">Bug Report: [short description]</span>
                </p>
              </div>
            </CardContent>
          </Card>
